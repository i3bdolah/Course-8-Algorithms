...
int main()
{
	sDate VacationDateSatrt;
	short VacationDays = 0;

	printf("\nVacation Start\n");
	VacationDateSatrt = FillDateInfo();

	VacationDays = EnterShort("\nEnter Number of Vacation Days: ");

	cout << "\n\n";


	cout << "Return Date: ";
	cout << GetDayNameByOrder(GetDayOrder(CalcReturnDate(VacationDateSatrt, VacationDays)));
	cout << ", ";
	PrintDate(CalcReturnDate(VacationDateSatrt, VacationDays));
	cout << "\n";
}
