...
int main()
{
	...
	// Second period: January 11, 2023 - January 20, 2023
	period2.start.days = 21;
	period2.start.months = 1;
	period2.start.years = 2023;
	period2.end.days = 20;
	period2.end.months = 1;
	period2.end.years = 2023;


	if (IsPeriodsOverlapped(period1, period2))
		cout << "Yes, It's Overlapped.";
	else
		cout << "No, It's not Overlapped.";
	if (AbuHaddHoudOverlap(period1, period2))
		cout << "Yes, It's Overlapped.";
	else
		cout << "No, It's not Overlapped.";
